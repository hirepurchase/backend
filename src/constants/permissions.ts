export const PERMISSIONS = {
  ...
  CANCEL_PENDING_CONTRACT: 'CANCEL_PENDING_CONTRACT',
...
export const PERMISSION_DEFINITIONS: PermissionDefinition[] = [
  ...
  { name: PERMISSIONS.UPDATE_CUSTOMER_PHONE, description: 'Change a customer phone number (held separately from general customer edits — the phone is the login and the payment identity)', category: 'Customers', scope: 'action' },
  ...
  { name: PERMISSIONS.CANCEL_PENDING_CONTRACT, description: 'Cancel a contract that has not been approved yet', category: 'Contracts', scope: 'action' },
...
// by scopeService, so the assigned-scope permission belongs here too.
